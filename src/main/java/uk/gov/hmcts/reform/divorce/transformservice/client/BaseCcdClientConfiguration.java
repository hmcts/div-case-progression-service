...
public class BaseCcdClientConfiguration implements CcdClientConfiguration {
    ...
    @Override
    public String getCases(String userToken, String queryParams) {
        return String.format(RETRIEVE_CASE_IDS_URL_FORMAT, ccdBaseUrl, jurisdictionId, caseTypeId, queryParams);
    }
