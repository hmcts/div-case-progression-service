...
import uk.gov.hmcts.reform.divorce.transformservice.mapping.DivorceCaseToCCDMapperTemp;

import java.util.Map;
import java.util.Objects;

@Component
public class DivorceToCcdTransformationServiceTemp implements TransformationService {

    private final ObjectMapper objectMapper;

    private final DivorceCaseToCCDMapperTemp divorceCaseToCCDMapper;

    @Autowired
    public DivorceToCcdTransformationServiceTemp(DivorceCaseToCCDMapperTemp divorceCaseToCCDMapper) {
