...
public class DraftsController {
    ...
    public ResponseEntity<Void> saveDraft(
        ...
        System.out.println(String.format("DraftsController#saveDraft Received JWT [%s]", jwt));
    ...
    public ResponseEntity<JsonNode> retrieveDraft(
        ...
        System.out.println(String.format("DraftsController#retrieveDraft Received JWT [%s]", jwt));
    ...
    public ResponseEntity<Void> deleteDraft(@RequestHeader("Authorization")
        ...
        System.out.println(String.format("DraftsController#deleteDraft Received JWT [%s]", jwt));
