...
public class EmailService {
    ...
    public void sendIssuanceNotificationEmail(String              destinationAddress,
                                              Map<String, String> templateVars) {
        String      templateName = EmailTemplateNames.APPLIC_ISSUANCE.name();
        EmailToSend emailToSend  = generateEmail(destinationAddress, templateName, templateVars);

        sendEmail(emailToSend, "issuance notification");
    }
    ...
    private void sendEmail(EmailToSend emailToSend,
        ...
        try {
            ...
            log.info("Email successfully sent. Reference ID: {}", emailToSend.getReferenceId());
