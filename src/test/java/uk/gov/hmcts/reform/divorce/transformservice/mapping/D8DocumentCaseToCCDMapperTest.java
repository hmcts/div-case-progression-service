...
public class D8DocumentCaseToCCDMapperTest {
    ...
    public void shouldMapAllAndTransformAllFieldsForD8DocumentGenerated() throws URISyntaxException, IOException {
        ...
        CoreCaseData expectedCoreCaseData = (CoreCaseData)DivorceCaseToCCDMapperTestUtil.jsonToPOJO("fixtures/ccdmapping/d8document.json", D8DocumentCaseToCCDMapperTest.class, CoreCaseData.class);
        ...
        DivorceSession divorceSession = (DivorceSession)DivorceCaseToCCDMapperTestUtil
                .jsonToPOJO("divorce-payload-json/d8-document.json", D8DocumentCaseToCCDMapperTest.class, DivorceSession.class);
